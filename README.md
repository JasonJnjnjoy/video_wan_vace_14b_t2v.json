# video_wan_vace_14b_t2v.json

Dockerized ComfyUI workflow: video_wan_vace_14B_t2v.json
...
docker build -t video_wan_vace_14b_t2v.json .

# Run the container
docker run -p 8188:8188 video_wan_vace_14b_t2v.json
```
